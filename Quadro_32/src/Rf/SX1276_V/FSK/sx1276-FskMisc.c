...
void SX1276FskRxCalibrate(tSX1276 *SX1276)
{
    ...
    initialFreq = SX1276FskGetRFFrequency( &SX1276);
    ...
    SX1276FskSetRFFrequency( 860000000,&SX1276 );
    ...
    SX1276FskSetRFFrequency( initialFreq ,&SX1276);
 ...
 */
static uint32_t SX1276FskComputeRxBw( uint8_t mantisse, uint8_t exponent,tSX1276 *SX1276 )
{
    // rxBw
 ...
 */
static void SX1276FskComputeRxBwMantExp( uint32_t rxBwValue, uint8_t* mantisse, uint8_t* exponent,tSX1276 *SX1276 )
{
    uint8_t tmpExp = 0;
    uint8_t tmpMant = 0;
...
void SX1276FskSetDccBw( uint8_t* reg, uint32_t dccValue, uint32_t rxBwValue,tSX1276 *SX1276 )
{
    ...
    SX1276FskComputeRxBwMantExp( rxBwValue, &mantisse, &exponent ,&SX1276);
...
uint32_t SX1276FskGetBw( uint8_t* reg,tSX1276 *SX1276 )
{
    ...
    rxBwValue = SX1276FskComputeRxBw( mantisse, ( uint8_t )*reg & 0x07 ,&SX1276);
    if( reg == &SX1276->RegRxBw )
    {
...
{
    return actualTemp - SX1276FskGetRawTemp(&SX1276 );
}

int8_t SX1276FskGetTemp( int8_t compensationFactor,tSX1276 *SX1276 )
{
    return SX1276FskGetRawTemp(&SX1276 ) + compensationFactor;
}
