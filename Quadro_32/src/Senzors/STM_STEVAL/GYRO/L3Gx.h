 ...
 */
#define L3gxByteRead(pVal,cAddress)      Gyro_read(cAddress,pVal,1)
/**
 * @brief Mapping of L3gxByteWrite in @ref L3gxBufferWrite.
 */
#define L3gxByteWrite(pVal,cAddress)     Gyro_send(cAddress,pVal,1)


#define L3gxBufferRead(pVal,cAddress,size)		Gyro_read(cAddress,pVal,size)
#define L3gxBufferWrite(pVal,cAddress,size)		Gyro_send(cAddress,pVal,size)
