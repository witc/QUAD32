 ...
 */
#define Lsm303dlhcAccI2CBufferRead(pVal,cAddress,nBytes)     Lsm303dlhcAccI2CBufferRead_f(pVal,cAddress,nBytes)
/**
 * @brief Mapping of Lsm303dlhcAccI2CBufferWrite in @ref Lsm303dlhcI2CBufferWrite.
 */
#define Lsm303dlhcAccI2CBufferWrite(pVal,cAddress,nBytes)     Lsm303dlhcAccI2CBufferWrite_f(pVal,cAddress,nBytes)

/**
 * @brief Mapping of Lsm303dlhcAccI2CByteRead in @ref Lsm303dlhcAccI2CBufferRead.
 */
#define Lsm303dlhcAccI2CByteRead(pVal,cAddress)               Lsm303dlhcAccI2CByteRead_f(pVal,cAddress)
/**
 * @brief Mapping of Lsm303dlhcAccI2CByteWrite in @ref Lsm303dlhcAccI2CBufferWrite.
 */
#define Lsm303dlhcAccI2CByteWrite(pVal,cAddress)              Lsm303dlhcAccI2CByteWrite_f(pVal,cAddress)
 ...
 */
#define LSM_A_I2C_ADDRESS         0x19//0x33
 ...
 */
#define Lsm303dlhcMagI2CBufferRead(pVal,cAddress,nBytes)      Lsm303dlhcMagI2CBufferRead_f(pVal,cAddress,nBytes)
/**
 * @brief Mapping of Lsm303dlhcMagI2CBufferWrite in @ref Lsm303dlhcI2CBufferWrite.
 */
#define Lsm303dlhcMagI2CBufferWrite(pVal,cAddress,nBytes)     Lsm303dlhcMagI2CBufferWrite_f(pVal,cAddress,nBytes)
